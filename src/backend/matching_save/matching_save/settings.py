"""
Django settings for matching_save project.
...
SECRET_KEY = 'django-insecure-8hfiqnu_)$h^b-6i4bm45xq_t^k!(^fc9ynv&kxs@zr*@r1q)g'
...
ROOT_URLCONF = 'matching_save.urls'
...
WSGI_APPLICATION = 'matching_save.wsgi.application'
